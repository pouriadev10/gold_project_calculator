...
/**
 * پرایمیتیو جدول shadcn/ui — با یک تغییر نسبت به نسخه‌ی رسمی: هدر ستون
 * از `text-start` استفاده می‌کند، نه `text-left` — قاعده‌ی خاصیت‌های
 * منطقی CSS (بخش ۶ CLAUDE.md، ESLint این‌ها را برای کلاس جهت‌دار خطا می‌دهد).
 */
