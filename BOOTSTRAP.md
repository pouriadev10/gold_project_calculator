...
- [x] ~~حالت روشن اجباری؛ حالت تاریک در این فاز نه~~
      **بازنگری‌شده:** حالت تاریک به دامنه‌ی فاز ۱ اضافه شد (تصمیم مالک محصول).
      پیش‌فرض `system` است — از تنظیم دستگاه پیروی می‌کند و انتخاب صریح کاربر
      بر آن مقدم است. توکن‌ها و نسبت‌های کنتراست هر دو حالت در
      `design-system/MASTER.md` بخش ۱ ثبت شده‌اند.
