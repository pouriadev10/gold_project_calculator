...
> **وضعیت: deferred / blocked by ledger foundation (2026-08-05).** طبق تأیید
> کاربر، این تسک پس از BE-029 تا BE-034 انجام می‌شود؛ افتتاحیه‌ی ناقص بدون
> posting دفتر کل پیاده‌سازی یا کامل اعلام نمی‌شود.
